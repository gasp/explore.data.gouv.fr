        ...
        <div class="fr-col-12 fr-col-md-4 fr-col-xl-3">
          <nav class="fr-sidemenu fr-sidemenu--sticky fr-p-0" aria-label="Menu latéral">
            <div class="fr-sidemenu__inner">
                <button class="fr-sidemenu__btn" hidden aria-controls="fr-sidemenu-wrapper" aria-expanded="false">DVF</button>
                <div class="fr-collapse" id="fr-sidemenu-wrapper">
                    <div class="fr-sidemenu__title fr-h6">DVF</div>
                    <button @click="testFct()">Toto</button>
                </div>
            </div>
          </nav>
        </div>
        <div id="map" class="map fr-col-12 fr-col-md-8 fr-col-xl-9" ref="mapContainer">
          <div id="titleMap" class="fr-px-1w fr-py-3v fr-text--sm fr-text--bold fr-m-0"></div>
        </div>
      </div>
    </div>
  </div>
...
import styleVector from '../static/json/vector-dvf.json'
import testDataset from '../static/json/epcis.json'
import testDataset2 from '../static/json/communes44.json'
import testDataset3 from '../static/json/sections44109.json'
